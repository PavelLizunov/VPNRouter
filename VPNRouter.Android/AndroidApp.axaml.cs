...
public partial class AndroidApp : Avalonia.Application
{
    ...
    private Control BuildSimplePageView()
    {
        ...
        // v2.32.0 — fullscreen Settings overlay (4-section parity with
        // desktop NetworkPage). Triggered from kebab > Diagnostics >
        // "Настройки".
        _settingsOverlay = BuildSettingsOverlay();

        return new Grid
        {
            Children = { mainScroller, _logOverlay, _appPickerOverlay, _settingsOverlay }
        };
    }
