...
- `VPNRouter.App/ViewModels/`: `MainWindowViewModel` partials and supporting ViewModels; see [ViewModels/AGENTS.md](ViewModels/AGENTS.md) for source navigation and connection-state ownership.
