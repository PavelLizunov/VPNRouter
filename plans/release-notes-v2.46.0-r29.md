# VPNRouter v2.46.0-r29 - True Split conflict diagnostics
...
- Supersedes r28: r28 was built without the bundled True Split driver; r29 bundles the driver with the lx-awg/xhttp Windows core.
