...
**Baseline SHA**: `b7ce0e4f` | **Fixed SHA**: `23cc4e52` / `c217389b` / `77b96a1b` / `b322d1fc` / `0072c571` | **Task Branch**: `dsh/fix-night-audit-gemini-2026-09-04` (PR #240) | **Isolated Baseline Branch**: `dsh/fix-night-audit-red-verification-2026-09-05` (Commits `0a876da6`, `5f718912`, `7c8fe020`, `0d757660`)
**Policy Rule**: Pre-fix RED states for 9 of 12 defect IDs across 10 unique tests (8 behavioral + 1 source wiring: NIGHT-01, 02, 03, 04 [Linux & Mac], 07, 09, 10, 11, 12) verified on isolated baseline runs 33969048431, 33970137690, 33970863633, and 33971648760; remaining 3 defects (NIGHT-05, 06, 08) explicitly labeled **NOT EXECUTED** (no retro-fabrication). All post-fix GREEN states mapped to actual CI runs (witness runs 33968752449, 33969900698, 33970601295, and 33971405494). Whole 12 closure remains pending; no promise of full solution/native; isolated baseline branch, no PR, no workflow edit, no release.
...
- **Current Defect Tally**: 9 of 12 defect IDs across 10 unique tests verified RED/GREEN (8 behavioral + 1 source wiring: NIGHT-01, NIGHT-02, NIGHT-03, NIGHT-04 [2 tests: Linux & Mac], NIGHT-07, NIGHT-09, NIGHT-10, NIGHT-11, NIGHT-12).
- **Remaining Defects**: Pre-fix RED for remaining 3 defects (NIGHT-05, NIGHT-06, NIGHT-08) remains **NOT EXECUTED** (no retro-fabrication).
- **Governance & Process Invariants**:
  ...
  - No live VPN or host infrastructure used; NIGHT-01 verified via custom handle double (not live OS port kill proof); NIGHT-12 verified via source inspection of named secret argument (not live WebSocket handshake).
