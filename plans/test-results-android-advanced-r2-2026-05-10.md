...
**Test asset**: `<redacted-test-subscription-url>` — **successfully exercised** this run.
...
**Surface**: any VPN connect using the test subscription URL `<redacted-test-subscription-url>` on this phone.
**Reproducer**: 1 step.
