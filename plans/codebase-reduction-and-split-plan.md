...
- [ ] T1-C MainWindowViewModel Banners + ThemeAndLogo — SHA: ____
- [ ] T2-D Wgturn redundant paths deleted — SHA: ____
- [ ] Track-3 precondition: full-platform build-warning pass — notes: ____
- [ ] T3-A EnsureAdapterEnabledOrAbsent removed + tests fixed — SHA: ____
- [ ] T2-D Zapret/TgProxy path centralization — SHA: ____
