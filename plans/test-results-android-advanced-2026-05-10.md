...
**Test asset**: `https://example.invalid/redacted-test-subscription`
...
- Advanced shell: Subscribe tab — including the redacted test URL `https://example.invalid/redacted-test-subscription`.
