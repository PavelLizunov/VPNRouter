...
- [ ] **Gate 1 — Build clean**: **EVIDENCE PENDING** (Control plane lacks .NET SDK; exact workflow commands must be inspected before asserting full solution build; Batch 1, Batch 2 [NIGHT-04, NIGHT-05 full integration], Batch 3 [NIGHT-08, NIGHT-07, NIGHT-06 `da3c21e7`], and Batch 4 [NIGHT-09/10 `530ca9e7`, NIGHT-12 `09db6ec5` & exception sanitizer `83a1bd48`, NIGHT-11 `7c980af47ebe3efa469bd744754fd4df5bbdfd8d`] all pass CI; NIGHT-08 Windows new work pending CI; limits full solution/live/macOS unchanged; red witnesses/full solution/native gaps remain; no live VPN/infra).
- [ ] **Gate 2 — Tests green**: **BLOCKED** on control plane (CI execution required; non-headless test suite; Batch 1, Batch 2 [NIGHT-04, NIGHT-05 full integration on `8ee89105635bc750932084c6dad09467cbe1d8b9`, run 33954240530: 3163 total / 3105 passed / 58 skipped], Batch 3 [NIGHT-08 `1ca812f4`, run 33951772995; NIGHT-07 `5ecbe4d2`, run 33955634699: 3184 total / 3126 passed / 58 skipped; NIGHT-06 `da3c21e7`, run 33956946168: 3194 total / 3136 passed / 58 skipped], and Batch 4 [NIGHT-09/10 `530ca9e7`, run 33957757306: 3221 total / 3163 passed / 58 skipped; NIGHT-12 `09db6ec5`, run 33958360119: 3232 total / 3174 passed / 58 skipped, receipt 5550942375; NIGHT-11 `7c980af47ebe3efa469bd744754fd4df5bbdfd8d`, run 33960085565: Ubuntu 3278 total / 3220 passed / 58 skipped, receipt 5551122167; NIGHT-12 exception sanitizer `83a1bd48`, run 33961291200: all 4 green, scoped logger synthetic token test not liveWS] PASS on CI; NIGHT-08 Windows new work pending CI; red witnesses/full solution/native gaps remain; no live VPN/infra).
- [ ] **Gate 3 — Docs**: **PASS** (Brief revised; `plans/OPEN-DEFECTS.md` active; report imported; NIGHT-FOLLOWUP-01 and NIGHT-FOLLOWUP-02 registered; ledger all still open pending closure evidence; no fake full gate; no closure claim for all 12).
- [ ] **Gate 4 — Independent review**: **PARTIAL / PENDING** (Adversarial review / bug-hunt per batch; Batch 1, Batch 2, Batch 3, and Batch 4 green on CI; NIGHT-12 exception sanitizer `83a1bd48` all 4 green on CI run 33961291200 with scoped logger synthetic token test not liveWS; NIGHT-08 Windows new work pending CI with touched SingBoxManager.Lifecycle.cs + new NightWindowsStopCharacterizationTests.cs, Windows filter includes Characterization now; keep 06/11 survivors [NIGHT-06 failover rollback race, NIGHT-11 stats context refresh] and red evidence pending; rejected reviewer duplicate hot-reload is existing deliberate fallback internal retries not P1; red witnesses/full solution/native gaps remain; no live VPN/infra; full review gate remains open; ledger all still open pending closure evidence; no fake full gate; no closure claim for all 12).
...
- `plans/phase-fix-night-audit-gemini-2026-09-04.md` (brief updated with NIGHT-12 exception sanitizer `83a1bd48` run 33961291200 all 4 green, scoped logger synthetic token test not liveWS; NIGHT-08 Windows new work pending CI with Lifecycle + new NightWindowsStopCharacterizationTests, Windows filter includes Characterization now; keep 06/11 survivors and red evidence pending)
...
- `VPNRouter.Core/Services/SingBoxManager.Lifecycle.cs` (NIGHT-08 `RestartCore` bool outcome and exact-stop failure handling committed `143d2adf`; Windows unconfirmed stop handle retention and TUN lease preservation; new work pending CI)
...
- `VPNRouter.Tests/NightWindowsStopCharacterizationTests.cs` (NIGHT-08 Windows stop characterization tests; selected by Windows runner filter `FullyQualifiedName~Characterization`; new work pending CI)

**Gate results**:
- [-] Gate 1: BATCH 1, BATCH 2 (NIGHT-04, NIGHT-05 FULL INTEGRATION `8ee89105635bc750932084c6dad09467cbe1d8b9`, run 33954240530), BATCH 3 (NIGHT-08 `1ca812f4`, run 33951772995; NIGHT-07 `5ecbe4d2`, run 33955634699; NIGHT-06 `da3c21e740c7b5905158cbf6d4b568d922ff8bf7`, run 33956946168), and BATCH 4 (NIGHT-09/10 `530ca9e7c8c8074267b67398d80d67f2022ff4df`, run 33957757306; NIGHT-12 `09db6ec5`, run 33958360119 & exception sanitizer `83a1bd48`, run 33961291200; NIGHT-11 `7c980af47ebe3efa469bd744754fd4df5bbdfd8d`, run 33960085565) PASS ON CI. NIGHT-08 Windows new work pending CI; limits full solution/live/macOS unchanged; red witnesses/full solution/native gaps remain; no live VPN/infra.
- [-] Gate 2: BATCH 1, BATCH 2 (NIGHT-04, NIGHT-05 FULL INTEGRATION `8ee89105635bc750932084c6dad09467cbe1d8b9`, run 33954240530: 3163 total / 3105 passed / 58 skipped), BATCH 3 (NIGHT-08 `1ca812f4`, run 33951772995; NIGHT-07 `5ecbe4d2`, run 33955634699: 3184 total / 3126 passed / 58 skipped; NIGHT-06 `da3c21e740c7b5905158cbf6d4b568d922ff8bf7`, run 33956946168: 3194 total / 3136 passed / 58 skipped), and BATCH 4 (NIGHT-09/10 `530ca9e7c8c8074267b67398d80d67f2022ff4df`, run 33957757306: 3221 total / 3163 passed / 58 skipped; NIGHT-12 `09db6ec5`, run 33958360119: 3232 total / 3174 passed / 58 skipped, receipt 5550942375; NIGHT-11 `7c980af47ebe3efa469bd744754fd4df5bbdfd8d`, run 33960085565: Ubuntu 3278 total / 3220 passed / 58 skipped, receipt 5551122167; NIGHT-12 exception sanitizer `83a1bd48`, run 33961291200: all 4 green, scoped logger synthetic token test not liveWS) PASS ON CI. NIGHT-08 Windows new work pending CI; red witnesses / full solution / native gaps remain; no live VPN/infra.
- [x] Gate 3: PASS (brief updated; ledger all still open pending closure evidence; no fake full gate; NIGHT-FOLLOWUP-01 and NIGHT-FOLLOWUP-02 registered; no closure claim for all 12).
- [-] Gate 4: PARTIAL / PENDING (Batch 1, Batch 2 [NIGHT-04, NIGHT-05 full integration], Batch 3 [NIGHT-08, NIGHT-07, NIGHT-06], and Batch 4 [NIGHT-09/10, NIGHT-12, NIGHT-11] green on CI; NIGHT-12 exception sanitizer `83a1bd48` all 4 green on CI run 33961291200 with scoped logger synthetic token test not liveWS; NIGHT-08 Windows new work pending CI with touched SingBoxManager.Lifecycle.cs + new NightWindowsStopCharacterizationTests.cs, Windows filter includes Characterization now; keep 06/11 survivors [NIGHT-06 failover rollback race, NIGHT-11 stats context refresh] and red evidence pending; rejected reviewer duplicate hot-reload confirmed as existing deliberate fallback internal retries not P1; red witnesses/full solution/native gaps remain; no live VPN/infra; full review gate remains open; ledger all still open pending closure evidence; no fake full gate; no closure claim for all 12).
...
**Follow-ups**: Address final review provisional survivors and pending CI: (1) NIGHT-08 Windows unconfirmed stop catch/dispose handle and release lease fix in `SingBoxManager.Lifecycle.cs` + new `NightWindowsStopCharacterizationTests.cs` (new work pending CI; Windows runner filter includes `Characterization` now); (2) NIGHT-06 `AutoFailoverEngine.cs:196, 221` race where queued old callback overwrites committed Apply selector C with old A on false (survivor pending correction, do not claim resolved all); (3) NIGHT-11 stats client identity refresh during Apply while `IsConnected == true` (`MainWindowViewModel.ConnStats.cs:55–83`, survivor context refresh pending); (4) NIGHT-12 exception sanitizer verified green on CI (`83a1bd48`, run 33961291200, scoped logger, synthetic token test, not liveWS); (5) address preexisting P1 baseline survivor NIGHT-FOLLOWUP-02 (SafeMode route semantic mismatch in `StartupPipeline.cs:699–716`, deferred outside 12 repair scope) alongside existing NIGHT-FOLLOWUP-01 (deferred owner follow-up); maintain `plans/OPEN-DEFECTS.md` (all 12 original defects still open pending closure evidence; no fake full gate; no closure claim for all 12; red witnesses/full solution/native gaps remain; no live VPN/infra); track NIGHT-DOC in PR #235 review; profile owner monitor (NIGHT-MEASURE).
...
1. **NIGHT-08 — Windows Unconfirmed Stop Handle Disposal & Lease Release (New Work Pending CI)**:
   ...
   - **New Work Implemented (Pending CI)**:
   ...
   - **Currently Touched**: `VPNRouter.Core/Services/SingBoxManager.Lifecycle.cs` + new `VPNRouter.Tests/NightWindowsStopCharacterizationTests.cs`.
   - **Windows Runner Filter**: Workflow command `dotnet test ... --filter "FullyQualifiedName~Characterization|FullyQualifiedName~PostShipVerifierContractTests|FullyQualifiedName~BratVerifierContractTests"` includes `Characterization` now, so `NightWindowsStopCharacterizationTests` will be selected and executed on Windows CI.
   - **Assessment**: New work implemented in working tree pending CI.

2. **NIGHT-06 — AutoFailoverEngine Mutated Settings Rollback Race (Further Correction Pending)**:
   - **Exact Source**: `VPNRouter.Core/Services/AutoFailoverEngine.cs:196, 208, 221`.
   - **Evidence & Facts**: In `AutoFailoverEngine.cs:196`, failover directly mutates settings before restart:
     ...
     ```
     This rollback occurs without verifying whether the user intent or settings context is still valid. If an older queued failover callback was awaiting restart while a committed `ApplyAsync` applied a new selector C, and the restart then returns `false`, line 221 rolls back to `oldActive` (`oldA`), overwriting the newly committed selector C with stale selector A.
   - **Assessment**: NIGHT-06 survivor pending correction; keep survivor and red evidence pending (do NOT claim resolved all).

3. **NIGHT-11 — Stats Client Identity Stale Across In-Place Apply (Context Refresh Pending)**:
   - **Exact Source**: `VPNRouter.App/ViewModels/MainWindowViewModel.ConnStats.cs:55–83`.
   - **Evidence & Facts**: `OnIsConnectedChanged(bool value)` tears down and recreates `_statsApi` ONLY when `IsConnected` changes state (`true <-> false`). During an in-place tunnel reconfigure or `ApplyAsync` where `IsConnected` remains `true`, `_statsApi` identity is not refreshed. In-flight polls or subsequent polling ticks can accept old data or query an outdated endpoint across reconfigurations.
   - **Assessment**: NIGHT-11 survivor context refresh pending; keep survivor and red evidence pending. CI green on `7c980af4` (Ubuntu 3278/3220/58, receipt `5551122167`).

4. **NIGHT-FOLLOWUP-02 (P1) — Baseline SafeMode Route Semantic Mismatch (Deferred Outside 12 Scope)**:
...
5. **NIGHT-12 — Telemetry Exception Sanitizer (Verified on CI `83a1bd48`)**:
...
6. **Defect Ledger & Invariant Guard**:
   - **Don't close any original 12 yet**: All 12 defects remain `- [ ]` open in `plans/OPEN-DEFECTS.md`.
   - **Keep 06/11 survivors and red evidence pending**: AutoFailover rollback race (NIGHT-06) and ConnStats client identity context refresh (NIGHT-11) survivors remain recorded and pending; red witnesses/full solution/native gaps remain; no invented red witness guaranteed gates worker report evidence.
   - **No other files, agents, build, or Git operations**: Changes strictly restricted to `plans/phase-fix-night-audit-gemini-2026-09-04.md`.
