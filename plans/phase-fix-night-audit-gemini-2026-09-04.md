...
**Status**: ALL 12 IMPLEMENTATIONS COMPLETE ACROSS BATCHES 1–4 AND VERIFIED ON CI / BASELINE RED OBSERVED RUN 33969048431 (EXACT 0a876da6, PARENT b7ce0e4f + ONLY NightBaselineRegressionTests SHA256 4905d9e6be76d3192865dd0b9726003c7171a6c34c331f1b2d142702d207cdd3; 5 TESTS ASSERTIONS FAIL [02 expected wg actual dns-direct, 03 vpn-dns/local-dns, 07 Connected/StartTaskCompleted, 09 peak 8/20, 10 ThrowsAny<OCE> no exception]; GO/WINDOWS CHARACTERIZATION GREEN) / GREEN c217389b RUN 33968752449 ALL 4 GREEN EXPLICITLY 5 PASSED / BASELINE RED OBSERVED NIGHT-04 RUN 33970137690 (EXACT 5f718912, PARENT b7ce0e4f + ONLY NightBaselineFirewallTests SHA256 bf12cfe2c226f794380c4719798ed80dc9eca7910c3b3422d7d8995d70fdb713; BOTH LINUX & MAC BASELINE FAILED Assert.True(File.Exists) NOT Assert.False AFTER FAILURE COUNTERPOSITIVE) / GREEN 77b96a1b RUN 33969900698 ALL 4 GREEN TWO EXPLICIT PASSES (RECEIPT 5552295438) / BASELINE RED OBSERVED NIGHT-11 RUN 33970863633 (EXACT 7c8fe020f9641833e6979c2999b0f5d93c3d658b, PARENT b7ce0e4f + ONLY NightBaselineStatsTests SAME FIXTURE SHA256 6845913ec2b2f40c241c33f15118444b11467cc38d5ae1071155ecaca5715767; EXPECTED EMPTY ACTUAL OLDTEXT /tmp/vpnrouter-stats-baseline-red.log; 8 TESTS FAILED) / GREEN b322d1fcf9ca416e905e887fcbca19a1ed5e745b RUN 33970601295 ALL 4 GREEN (RECEIPT 5552381401) / BASELINE RED OBSERVED NIGHT-01 & NIGHT-12 RUN 33971648760 (EXACT 0d757660b0d39c03fafd6e89df8d3866a7320965, PARENT b7ce0e4f + OWNERSHIP FIXTURE SHA256 347dcda9986f86b83e9a529fe2f8b19dba95b430aa54fbc05b1ae2f39b049101 AND WIRING FIXTURE SHA256 3b9a9c0d92b99e35664a59d7bada4b2b547e3db8778febfdd6af60ffb8406c05; 01 FAILEDSTOP CUSTOMHANDLE ACTUAL NULL ASSERTSAME ON LINUX & WINDOWS NOT LIVEPORTKILLPROOF; 12 SOURCE-ONLY NAMED SECRET ARG ABSENCE IN VPNENGINE CTOR NOT LIVE HANDSHAKE) / GREEN 0072c571ad621265172179cf91e58acb2f0f32b3 RUN 33971405494 ALL 4 GREEN (RECEIPT 5552469312) / BASELINE RED OBSERVED NIGHT-08 RUN 33972547099 (EXACT 9975c168849c3735721ccb936f40b6436d4de1d7, PARENT b7ce0e4f + WINDOWSSTOP FIXTURE SHA256 56c5af60bfe4a04725357084088e76a4e91e38ffe68b355612f28e337ff0e6a6; UNCONFIRMED STOP ACTUAL NULL ASSERTSAME VS EXPECTED HANDLE; SCOPED WINDOWSSTOP OWNERSHIP NOT STANDALONE APPLY PROOF) / GREEN 945866c44a98f9825e04166620ac115772d4afbf RUN 33972290164 WINDOWS 69 PASS 0 SKIP ALL 4 GREEN (RECEIPT 5552568409) / BASELINE RED OBSERVED NIGHT-05 RUN 33973908946 (EXACT 4dbb28df5294b32c7a34b49b15b69ed38c05409a, PARENT b7ce0e4f + SCOPED WG PEER FIXTURE SHA256 c01d04feb664b223ffe0bd76b437faf9458e32a768b5f91836b780ecc638d50f; TWO TRUE CASES FAIL MISSING 2001:db8::8, TWO FALSE CONTROLS PASS; SCOPED WG PEER ALLOWANCE NOT FULL APPLY/NATIVE DNS PROOF; REJECTED INITIAL CANDIDATE 32f11e13 VS 6e789f11 RUN 33973195145 DUALSTACK FAKE DNS BOTH BASELINE PASSED BYPASSING DefaultResolveHostIPv4 FILTER, NOT RED) / GREEN 54d6080c2c2445fbec075b5f1be3d39ba3d94f13 RUN 33973667482 FOUR PASS ALL 4 GREEN (RECEIPT 5552732672) / TALLY 11 OF 12 DEFECT IDS ACROSS 12 UNIQUE TESTS (10 BEHAVIORAL + 1 SOURCE WIRING) RED/GREEN / REMAINING 1 (06) NOT EXECUTED / WHOLE 12 CLOSURE PENDING / NO PROMISE FULL SOLUTION/NATIVE / ISOLATED BASELINE BRANCH dsh/fix-night-audit-red-verification-2026-09-05 NO PR NO WORKFLOW EDIT NO RELEASE / LEAD SOURCE VERIFICATION REJECTS TgProxyPid THROWS FINDING (ACTUAL Core/Services/ProcessRunner.cs:213 CACHED AUTO Pid PROPERTY, NOT Process.Id OS LOOKUP; FABRICATED CUSTOM fakePidThrow DOESN'T DEMONSTRATE PRODUCT BUG) / SAFEMODE FINDING DUPLICATE FOLLOWUP-02 REMAINS DEFERRED / DEFECT LEDGER ALL 12 STILL OPEN PENDING RED CHECKLIST EVIDENCE / NO LIVE VPN
...
- **Observed Baseline RED (Batch D — NIGHT-01 Process Ownership Handle & NIGHT-12 Telemetry Secret Wiring)**: Run [33971648760](https://github.com/PavelLizunov/VPNRouter/actions/runs/33971648760) on exact commit `0d757660b0d39c03fafd6e89df8d3866a7320965` (isolated branch `dsh/fix-night-audit-red-verification-2026-09-05`, based on parent `b7ce0e4f` plus ownership fixture SHA256 `347dcda9986f86b83e9a529fe2f8b19dba95b430aa54fbc05b1ae2f39b049101` and wiring fixture SHA256 `3b9a9c0d92b99e35664a59d7bada4b2b547e3db8778febfdd6af60ffb8406c05`). Built successfully; observed RED failures on baseline:
  - **NIGHT-01**: `failedStop` with custom handle returned actual `null` vs expected handle (`Assert.Same` failed on Linux & Windows; handle was cleared on failed stop instead of being retained; not a live OS port kill proof)
...
- **Fixed GREEN Witness (Batch D — NIGHT-01 & NIGHT-12)**: Run [33971405494](https://github.com/PavelLizunov/VPNRouter/actions/runs/33971405494) on commit `0072c571ad621265172179cf91e58acb2f0f32b3`. All 4 checks green; passed. Receipt [5552469312](https://github.com/PavelLizunov/VPNRouter/pull/240#issuecomment-5552469312).
- **Observed Baseline RED (Batch E — NIGHT-08 Windows Unconfirmed Stop Handle Retention)**: Run [33972547099](https://github.com/PavelLizunov/VPNRouter/actions/runs/33972547099) on exact commit `9975c168849c3735721ccb936f40b6436d4de1d7` (isolated branch `dsh/fix-night-audit-red-verification-2026-09-05`, based on parent `b7ce0e4f` plus WindowsStop fixture SHA256 `56c5af60bfe4a04725357084088e76a4e91e38ffe68b355612f28e337ff0e6a6`). Built successfully; observed RED failure on baseline: `failedStop` with custom handle returned actual `null` vs expected handle (`Assert.Same` failed; handle cleared on unconfirmed stop instead of being retained; scoped WindowsStop ownership, not standalone Apply proof).
- **Fixed GREEN Witness (Batch E — NIGHT-08)**: Run [33972290164](https://github.com/PavelLizunov/VPNRouter/actions/runs/33972290164) on commit `945866c44a98f9825e04166620ac115772d4afbf`. All 4 checks green; Windows runner 69 passed, 0 skipped. Receipt [5552568409](https://github.com/PavelLizunov/VPNRouter/pull/240#issuecomment-5552568409).
- **Observed Baseline RED (Batch F — NIGHT-05 Scoped WireGuard Peer Allowance)**: Run [33973908946](https://github.com/PavelLizunov/VPNRouter/actions/runs/33973908946) on exact commit `4dbb28df5294b32c7a34b49b15b69ed38c05409a` (isolated branch `dsh/fix-night-audit-red-verification-2026-09-05`, based on parent `b7ce0e4f` plus scoped WG peer fixture SHA256 `c01d04feb664b223ffe0bd76b437faf9458e32a768b5f91836b780ecc638d50f`). Built successfully; observed RED failure on baseline: TWO true cases failed with missing `2001:db8::8` (WireGuard peer IPv6 endpoint unparsed on baseline), and TWO false controls passed. Scope is WG peer allowance, not full Apply/native DNS proof. Initial candidate `32f11e13` vs `6e789f11` (run 33973195145) with dual-stack fake DNS was explicitly rejected because BOTH baseline tests passed (injected resolver bypassed the baseline `DefaultResolveHostIPv4` filter) and was therefore NOT RED.
- **Fixed GREEN Witness (Batch F — NIGHT-05)**: Run [33973667482](https://github.com/PavelLizunov/VPNRouter/actions/runs/33973667482) on commit `54d6080c2c2445fbec075b5f1be3d39ba3d94f13`. All 4 checks green (four pass / all 4 green). Receipt [5552732672](https://github.com/PavelLizunov/VPNRouter/pull/240#issuecomment-5552732672).
- **Current Verified Defect Tally**: 11 of 12 defect IDs across 12 unique tests verified RED/GREEN (10 behavioral + 1 source wiring: NIGHT-01, 02, 03, 04 [2 tests: Linux & Mac], 05, 07, 08, 09, 10, 11, 12).
- **Remaining Defect**: Pre-fix RED for remaining 1 defect (NIGHT-06) remains **NOT EXECUTED** (no retro-fabrication).
- **Process & Policy Invariants**:
  ...
  - No live VPN or host infrastructure used; NIGHT-01 verified via custom handle double (not live OS port kill proof); NIGHT-05 verified via scoped WG peer allowance (not full Apply/native DNS proof); NIGHT-08 verified via scoped WindowsStop ownership (handle retained on unconfirmed stop, not standalone Apply proof); NIGHT-12 verified via source inspection of named secret argument (not live WebSocket handshake).
  - Lead source verification rejects proposed `TgProxyPid` throws finding: `VPNRouter.Core/Services/ProcessRunner.cs:213` uses a cached auto-property (`public int Pid { get; private set; }`), NOT an OS `Process.Id` query; fabricated custom `fakePidThrow` test double does not demonstrate a product bug.
