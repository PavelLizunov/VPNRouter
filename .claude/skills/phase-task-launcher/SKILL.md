...
- Phase 2 god-file splits → `claude/ph2-<slug>-<seq>` feature branch off `v3.0-prep`
- Phase 2 abstractions (interfaces) → `claude/ph2-<slug>-<seq>`
...
3. **Docs**: brief Outcome section filled (Commits, Test deltas, Files changed, Surprises, Follow-ups). README updated if user-facing surface changed. CLAUDE.md updated if architecture changed.
4. **Self-review**:
