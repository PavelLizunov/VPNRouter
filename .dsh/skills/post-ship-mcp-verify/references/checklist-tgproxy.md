...
2. Resolve the current RU main-action label from `VPNRouter.Core/Localization/Strings.Telegram.cs`, its App pass-through, and XAML. The button has `AutomationProperties.Name="{Binding LblTgProxyMainAction}"`; inspect it, then invoke it:
