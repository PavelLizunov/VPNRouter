...
public sealed class CrashReporterScrubberTests
{
    ...
    [InlineData("ws://example.com/api?client_secret=secret999", "client_secret=[REDACTED]")]
    [InlineData("wss://example.com/api?refresh_token=ref12345", "refresh_token=[REDACTED]")]
    [InlineData("ws://example.com/api?auth_token=authtok99", "auth_token=[REDACTED]")]
