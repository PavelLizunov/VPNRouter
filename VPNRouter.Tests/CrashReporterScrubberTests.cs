...
public sealed class CrashReporterScrubberTests
{
    ...
    [InlineData("wss://example.com/api?accesstoken=tok12345", "accesstoken=[REDACTED]")]
    [InlineData("wss://example.com/api?refresh_token=tok67890", "refresh_token=[REDACTED]")]
    [InlineData("wss://example.com/api?refreshtoken=tok67890", "refreshtoken=[REDACTED]")]
    ...
    [InlineData("wss://example.com/api?clientsecret=sec99887", "clientsecret=[REDACTED]")]
    ...
    [InlineData("ws://example.com/api?clientpassword=mypassword", "clientpassword=[REDACTED]")]
