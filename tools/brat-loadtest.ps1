...
if ([string]$result.Lifecycle -notin @('PayloadNotApproved', 'EndpointUnavailable', 'MeasurementGated', 'Completed', 'ReplyGap', 'CookieFailure', 'NetworkFailure', 'InternalFailure', 'PayloadHashMismatch', 'PayloadMissing', 'PayloadTimeout', 'PayloadExitNonZero', 'PayloadOutputMissing', 'PayloadOutputEmpty', 'PayloadFailed', 'PayloadResultInvalid')) { throw 'Verifier returned an invalid lifecycle enum.' }
